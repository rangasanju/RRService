      ...
      <div class="site-wrapper-inner">
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Upload Image Successfull</h1>
	      ...
	      <div class="col-sm-8">	
		  	 ...
		  	 <div class="col-sm-12">
	            <img id="rrimg" src="http://localhost/img/runningroom.jpg" class="img-responsive img-rounded" alt="Cinque Terre"> 
		     </div>
	      ...
	      <div class="col-sm-4">
			      	<a href="#" class="btn btn-lg btn btn-warning btn-primary-spacing" onclick="returnToParent()">Close</a> 	
		  </div>
	      <div class="col-sm-4">
              &nbsp;
	      </div>
