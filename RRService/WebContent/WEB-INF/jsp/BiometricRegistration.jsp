      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading"><i18n:message key="label.PAGETITLE.bio.registration"/></h1>
	      ...
	      <div class="col-sm-6">
	      	<a href="#" class="btn btn-lg btn-primary btn-primary-spacing" onclick="BioReg()">Register</a> 	
          </div>
           <div class="col-sm-6">
	      	<a href="#" class="btn btn-lg btn-primary btn-primary-spacing" onclick="returnToParent()">Return</a> 	
          </div>
	      <div class="col-sm-12">
              &nbsp;
	      </div>
			...
			try{
				...
				if (reqFeature.readyState == 3){ // Complete					
						...
						{ // OK response
							...
							{							
								alert("Your finger has been registered successfully");
							}else
								alert(xmlhtp);
						}
					}
